  ...
  return (
    ...
    <div className="min-h-screen bg-linear-to-br from-indigo-50 to-blue-100 flex items-center justify-center p-6">
      ...
      >
        ...
        {/* RUPAYE VISIBILITY EKA ADU KARANNE MEKAI */}
        ...
        <div className="md:w-6/12 p-8 md:p-14 z-20 flex items-center justify-center">
          {/* Glass Card for Form */}
          <div className="max-w-md mx-auto  bg-white/40 backdrop-blur-xl rounded-3xl p-10 shadow-xl border border-white/40">
            ...
            <form className="space-y-4">
                ...
                <div className="space-y-1 animate-in fade-in duration-500">
                  {role === "teacher" ? (
                    ...
                    <>
                      ...
                      <select className="w-full bg-white/60 border border-white/40 rounded-xl px-4 py-3 focus:ring-4 focus:ring-indigo-100 focus:border-indigo-400 outline-none transition-all appearance-none cursor-pointer text-gray-950 font-medium">
              ...
              <div className="pt-6 ">
                <button className="w-full bg-green-600  cursor-pointer tracking-wider text-white text-2xl font-bold py-4 rounded-3xl  shadow-[0_10px_20px_rgba(79,70,229,0.3)] ">
                  Create My Account
                </button>
